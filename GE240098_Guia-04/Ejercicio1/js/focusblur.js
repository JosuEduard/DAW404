//Elemento con la capa de ayuda a mostrar en los campos del formulario

let textoAyuda;

//Matriz con los mensajes de ayuda disponibles
...
let arregloAyuda = [
  ...
  "Díganos cúal es su país de origen en este campo select",
  "Restablezca el formulario con este botón",
  "Envie el formulario con este botón",
  ""
];

//Inicializar el elemeto texttoAyudaDiv y registrar los manejadores de eventos
//Para los distinto controles de formulario
...
//Con base en el numerodeMensaje enviado como argumento

function registrarEscuchas(objeto, numerodeMensaje) {
  /**
  ...
  objeto.addEventListener("focus", () => {
    ...
    textoAyuda.innerHTML = arregloAyuda[numerodeMensaje];
  }, false);
...
//Desencadendando la función inic al cargar el documento
