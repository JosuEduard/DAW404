...
function save() {
  ...
  let msg;
  //Verificar si se puede utilizar el localStorage en el navegador
  try {
...
function remove() {
  console.log('Removiendo el elemento del LocalStorage.');
...
function clearStorage() {
  divState.innerHTML = '';
  console.log('Borrando todo el contenido del Local Storge');
  localStorage.clear();
}
...
function saveArrayData() {
  ...
  console.log("Guardando arreglo de datos en localStorage."); localStorage.setItem("persons", JSON.stringify(myArrayObject));
}
