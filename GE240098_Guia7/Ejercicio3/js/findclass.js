...
function findClassInElements(className, type) {
  ...
  //El ciclo recorre toda la página comprobando en el elemento enviado a la función //si la clase está presente o no en dicho elemento. Si lo está se guarda dentro
